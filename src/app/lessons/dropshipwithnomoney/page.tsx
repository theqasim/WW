      ...
      <div className="bg-white p-8 rounded-lg shadow-xl w-4/5 md:w-2/3 lg:w-1/2 space-y-6">
        ...
        <div className="text-gray-700 space-y-4">
          ...
          <p>
            ...
            selling the product. The title of the product often isn&apos;t used, I&apos;d
            suggest saving the image from the listing and using Google Images to
            find the competitors as they will likely be using the same assets
            under different names. <br></br>
            <br></br>By looking at the competitors of the product, you can
            understand how they&apos;re marketing the product, what pain points they
            are using to sell the product (will cover more on this later) and
            overall, what your store could look like when selling this product.
            This is also a good way to identify potential <b>upsale items</b> as
            your competitors will have worked this out by now. <br></br>
          ...
          <p>
            Once you&apos;ve picked a product, you need to build a store. <br></br>
            <br></br>Head over to{" "}
            <a
            ...
            this to get 3 months worth of a Shopify Subscription for £1. You&apos;re
            getting a website capable of processing payments paired with a well
            designed theme for £1, you&apos;re welcome:{" "}
            <a
            ...
            <br></br>
            <br></br>Once youu&apos;ve signed up and changed your theme to the Sense
            theme. <b>You need to begin designing your store</b>, I&apos;d suggest
            taking inspiration from your competitors. Do not reinvent the wheel,
            simply take what works, improve on it if you can, and get your store
            up. <br></br>
            ...
            <br></br>Once you&apos;re happy with the store and the product page, we
            can move onto the next step, fulfilling orders.
          </p>
          ...
          <p>
            ...
            your new Shopify orders. Each order will have the customer&apos;s details
            ready, so all you need to do is choose the shipping method (varying
            in price and estimated duration). <br></br>
            ...
            already purchased the item so you&apos;re simply taking money from the
            order to purchase the item, and keeping the profit. <br></br>
          ...
          <p>
            ...
            TikTok, you can find competitors&apos; TikTok accounts and look at their
            views. The ones with the most success are ones you should be posting
            or replicating. Once you choose a few TikTok&apos;s to post on your
            account, we need to remove the watermark. Head over to{" "}
            <a
          ...
          <p>
            Double down on what works, and cut off what doesn&apos;t. Do not become
            attached to a particular way of marketing, you need to remember that
            the goal is to bring in sales, <b>by any means necessary</b>.
            Scaling with TikTok organic can be done through posting more content
            that gets a higher AVD (Average View Duration) Scaling with TikTok
            ads can be allocating more ad spend to higher converting ad
            creatives/campaigns.{" "}
          </p>
