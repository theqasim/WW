  ...
  return (
    <div>
      <button
        ...
        className="mt-4 max-w-s transition duration-300 ease-in-out hover:scale-110"
      >
          ...
          >
            <div className="flex items-center justify-center min-h-screen">
              <Dialog.Panel className="mx-auto max-w-md px-6 py-4 bg-white rounded-xl">
                ...
                <p className="mt-4">
                  You will be granted access to <b>detailed documentation</b> on
                  a variety of side hustles and online businesses.
                </p>
                <p className="mt-4">
                  Instead of wasting your time and money attempting to make
                  money online, you will be able to <b>learn from the best.</b>
                </p>

                <p className="mt-4">
                  You are joining a community of like-minded people who are all
                  working towards the same goal: <b>financial freedom.</b>
                </p>
                ...
                <p className="mt-4 text-red-600">
                  <b>
                    Important: Open access is temporary. Free entry will close
                    soon.
                  </b>
                </p>
