  ...
  return (
    <div className="flex flex-col items-center justify-center md:w-3/4 sm:w-4/4">
      ...
      <video ref={videoRef} controls className="w-full shadow-lg">
        <source src="https://www.dropbox.com/scl/fi/dffep9g6dmjgxfagq0zt5/Easiest-AI-Side-Hustle-of-2023.mp4?rlkey=r6aacexcymr8b6parw5304fss&dl=1" type="video/mp4" className="" />
